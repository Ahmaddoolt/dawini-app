...
class MedicalCulturePage extends StatefulWidget {
  const MedicalCulturePage({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _MedicalCulturePageState createState() => _MedicalCulturePageState();
}

class _MedicalCulturePageState extends State<MedicalCulturePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('MedicalCulture').tr(),
      ),
      body: Stack(
        children: [
          StreamBuilder(
